 ...
 * Supports macOS (Terminal.app/iTerm2), WSL (Windows Terminal), and Linux (gnome-terminal/konsole/xterm).
 */
 ...
 * On Linux, uses the detected terminal emulator's multi-tab support where available.
 */
